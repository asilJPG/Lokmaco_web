...
// Фотоотчёты о приходах идут в свою группу. Если переменная не задана —
// падаем на общий TG_CHAT_ID, чтобы отчёт не потерялся молча.
const TG_CHAT_ID = process.env.TG_INVOICE_CHAT_ID || process.env.TG_CHAT_ID || "";
