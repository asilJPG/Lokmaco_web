...
- Вкладка «Цены»: история закупочных цен и алерты. Источник — `documents/export/incomingInvoice` (все накладные с ценами одним XML-запросом, своя таблица в БД НЕ нужна).
