...
const ITEMS: Item[] = [
  ...
  { href: '/dashboard/cashier', label: 'Касса · закрыть смену', icon: '🧾', group: 'Операции' },
  { href: '/dashboard/history', label: 'История смен', icon: '🗂️', group: 'Операции' },
  { href: '/dashboard/safe', label: 'Сейф', icon: '💰', group: 'Аналитика' },
  ...
  { href: '/dashboard/inbox', label: 'Подтверждения', icon: '📨', group: 'Склад' },
  ...
  { href: '/dashboard/profile', label: 'Профиль', icon: '🙂', group: 'Аккаунт' },
  { href: '/dashboard/admin', label: 'Админ-панель', icon: '⚙️', group: 'Аккаунт', adminOnly: true },
  { href: '/dashboard/admin/users', label: 'Админ · Пользователи', icon: '👤', group: 'Аккаунт', adminOnly: true },
  { href: '/dashboard/admin/filials', label: 'Админ · Филиалы', icon: '🏢', group: 'Аккаунт', adminOnly: true },
];
